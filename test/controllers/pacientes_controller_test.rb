...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { correo_electronico: @paciente.correo_electronico, edad: @paciente.edad, nombre: @paciente.nombre }
    end
  ...
  test "should update paciente" do
    patch :update, id: @paciente, paciente: { correo_electronico: @paciente.correo_electronico, edad: @paciente.edad, nombre: @paciente.nombre }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
